...
<div class="row">
    <form class="form-inline" role="form" method="get">
        <input type="hidden" name="page" value="suspectList">
        <div class="col-lg-12">
            ...
            <?php if(!empty($fpInfo)): ?>
                <?php foreach ($fpInfo as $key=>$value):?>
                    <tr>
                        ...
                        <td><?php echo (isset($value['status'])&&$value['status'])?"Yes":"--" ?></td>
                        <td class="nameLst">
                            <a href="admin.php?page=employerList&passport_no=<?php echo $value['passport_no']; ?>">
                                Employer List
